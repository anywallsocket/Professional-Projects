...
if I==0: calc = MACECalculator(model_paths='r2scan.model', default_dtype='float64')
else: calc = MACECalculator(model_paths='NNs/'+str(I-1)+'/'+str(I-1)+'_compiled.model', default_dtype='float32')
